                                        ...
                                        CPU_BOOLEAN   *pnbr_neg)
{
    ...
    whitespace = ASCII_IS_SPACE(*pstr_parse);
             ...
             if (*pstr_parse == '0') {                          /* If avail, ...                                        */
                  ...
                  switch (*pstr_parse) {
                      ...
                      case 'X':
                           ...
                           nbr_hex    =  ASCII_IS_DIG_HEX(parse_char);
